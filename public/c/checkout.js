...
function continueToPlaceOrder() {
  ...
  if (!street || !city || !state || !zip) {
	...
	const allowedZips = [
	  "89166","89143","89131","89149","89130","89129","89134","89144","89145","89128",
	  "89108","89107","89102","89101","89104","89109","89169","89121","89120","89119",
	  "89103","89118","89123","89139","89113","89141","89183","89178","89179","89148",
	  "89147","89146","89117","89135","89138","89110","89142","89122","89156","89115",
	  "89106",
	  "89085","89087","89084","89086","89081","89031","89032","89030",
	  "89014","89011","89015","89002","89012","89052","89074",
	  "89044","89054"
	];

	if (!allowedZips.includes(zip)) {
	  alert("Sorry, we are currently unable to deliver to your zip code.");
	  return;
	}
...
function calculateDropoff() {
	...
	// If the user manually selected a dropoff time in the booking flow, use it.
	const manual = localStorage.getItem('rrpr_dropoff_manual');
	if (manual) {
		const parsed = JSON.parse(manual);
		return { dropoffDate: new Date(parsed.dropoffDate), dropoffWindow: parsed.dropoffWindow };
	}
...
function calculatePickup() {
	...
	// If the user manually selected a pickup time in the booking flow, use it.
	const manual = localStorage.getItem('rrpr_pickup_manual');
	if (manual) {
		const parsed = JSON.parse(manual);
		return { pickupDate: new Date(parsed.pickupDate), pickupWindow: parsed.pickupWindow };
	}
